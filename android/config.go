...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.Aoscp.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.AoscpConfig.JavaSourceOverlayModuleWhitelist
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Aoscp.Specific_camera_parameter_library)
}
